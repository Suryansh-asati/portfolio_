...
// Normalize trailing slash for /projects/
...
// Render projects page via EJS and pass data if view exists, else fallback to static
app.get('/projects', (req, res, next) => {
  const viewPath = path.join(__dirname, 'views', 'projects.ejs');
...
// Render home via EJS if exists to pass projects data, else static index.html
